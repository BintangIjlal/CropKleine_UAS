...
import com.example.kleine.databinding.SayurExtraAdsItemBinding
...
class AdsRecyclerAdapter : RecyclerView.Adapter<AdsRecyclerAdapter.AdsViewHolder>() {
    ...
    inner class AdsViewHolder(val binding: SayurExtraAdsItemBinding) :
    ...
    override fun onCreateViewHolder(
        ...
        return AdsViewHolder(
            SayurExtraAdsItemBinding.inflate(
