    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TabLayoutMediator(binding.tabLayout,binding.viewpagerHome){tab,position->
            ...
            when(position){
                ...
                1-> tab.text = resources.getText(R.string.g_susu)
                2-> tab.text = resources.getText(R.string.g_fresh)
                3-> tab.text = resources.getText(R.string.g_daging)
                4-> tab.text = resources.getText(R.string.g_olahan)
                5-> tab.text = resources.getText(R.string.g_bunga)
                6-> tab.text = resources.getText(R.string.g_herbal)
            }
